                ...
                script {
                    if (params.deployEnv == "${stagingEnv}") {
                        ...
                        sh '''
                            ...
                            docker run --rm --name kubectl -u root --net=host -v ${kubectlConfigPath}:/.kube/config -v ${minikubeClientCrtPath}:${minikubeClientCrtPath} -v ${minikubeClientKeyPath}:${minikubeClientKeyPath} -v ${minikubeCaCrtPath}:${minikubeCaCrtPath} ${dockerKubectlAws} apply -f ($pwd)/deployment.yaml
                            fi
                        '''
